...
export default function Reflection() {
  return (
    <section>
      <Editable page="Reflection" id="title" as="h1" text="Reflection" />
      <Editable
        page="Reflection"
        id="vacation"
        text={
      ...
      <Editable page="Reflection" id="timelineHeading" as="h2" text="Development Timeline" />
      <Editable page="Reflection" id="timelineIntro" text="A few milestones from my commit history." />
      <ul>
